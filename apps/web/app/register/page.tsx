...
const HERO = "https://placehold.co/720x560/f0f4ff/377dff?text=Join+us";
          ...
          <div className="row align-items-center">
            <div className="col-xl-8 col-lg-8 col-md-12 col-sm-12">
              <div className="_social_registration_right">
                ...
                <div className="_social_registration_right_image_dark d-none d-md-block">
                  <img src={HERO} alt="" />
                </div>
              </div>
            </div>
            <div className="col-xl-4 col-lg-4 col-md-12 col-sm-12">
              <div className="_social_registration_content">
                ...
                <form className="_social_registration_form" onSubmit={onSubmit}>
                  ...
                  {err ? <p className="text-danger small">{err}</p> : null}
                  <div className="row">
