...
/** Buddy `feed.html` profile menu — right chevron (use `<span>`, not `<button>`, inside `Link`) */
...
export function BuddyAppFrame({
  ...
  useEffect(() => {
    function onDoc(e: MouseEvent) {
      ...
      const inMobileNotif =
        notifMobileBtnRef.current?.contains(t) || notifMobilePanelRef.current?.contains(t);
  ...
  return (
    <div className={`_layout _layout_main_wrapper${dark ? " _dark_wrapper" : ""}`}>
      ...
      <div className="_main_layout">
            ...
            <div className="collapse navbar-collapse buddy-navbar-collapse" id="navbarSupportedContent">
              ...
              <ul className="navbar-nav mb-2 mb-lg-0 _header_nav_list _mar_r8">
                <li className="nav-item _header_nav_item">
                  <Link
                    className={`nav-link _header_nav_link${feedActive ? " _header_nav_link_active" : ""}`}
                  ...
                  <div className="_nav_profile_dropdown_info">
                    <div className="_nav_profile_dropdown_image">
                      <UserAvatar
                        ...
                        size={54}
                        shape="rounded-full"
                        className="shrink-0 ring-2 ring-[#377DFF] ring-offset-0 shadow-none"
                      />
                    </div>
        ...
        {notifOpen ? (
          <div
            ref={notifMobilePanelRef}
            className="_notification_dropdown show d-lg-none"
                ...
                <div className="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                  <ul className="_mobile_navigation_bottom_list">
                    <li className="_mobile_navigation_bottom_item">
                      <Link
                        href="/feed"
                        className={`_mobile_navigation_bottom_link${feedActive ? " _mobile_navigation_bottom_link_active" : ""}`}
                      >
