...
export function BuddyStoriesStrip({ me }: {
    me: PublicUser;
}) {
    ...
    return (<>
      <div className="_feed_inner_ppl_card _mar_b16">
        ...
        <div className="row">
          ...
          {[1, 2, 3].map((i) => (<div key={i} className={`col-xl-3 col-lg-3 col-md-4 col-sm-4 col${i > 1 ? " _custom_mobile_none" : ""}${i > 2 ? " _custom_none" : ""}`}>
              <div className="_feed_inner_public_story _b_radious6" role="button" tabIndex={0} onClick={() => showComingSoon("Stories")} onKeyDown={(e) => {
      ...
      <div className="_feed_inner_ppl_card_mobile _mar_b16">
        <div className="_feed_inner_ppl_card_area">
          <ul className="_feed_inner_ppl_card_area_list">
            ...
            {[1, 2, 3].map((i) => (<li key={i} className="_feed_inner_ppl_card_area_item">
                <button type="button" className="_feed_inner_ppl_card_area_link" style={{ border: "none", background: "transparent", padding: 0, width: "100%", cursor: "pointer", font: "inherit", color: "inherit" }} onClick={() => showComingSoon("Stories")}>
