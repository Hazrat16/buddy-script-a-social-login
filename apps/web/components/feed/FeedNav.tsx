    ...
    <header className="sticky top-0 z-40 border-b border-slate-200/90 bg-white/85 backdrop-blur-xl dark:border-slate-800/90 dark:bg-slate-950/85">
      <div className="mx-auto flex max-w-6xl items-center justify-between gap-3 px-4 py-3 sm:gap-4 sm:px-6">
        ...
        <div className="flex items-center gap-1 sm:gap-2">
          <button
            type="button"
            className="hidden rounded-xl border border-slate-200 p-2 text-slate-600 transition hover:bg-slate-100 dark:border-slate-700 dark:text-slate-300 dark:hover:bg-slate-800 sm:inline-flex"
          ...
          <div className="relative" ref={notifRef}>
            <button
              type="button"
              className="relative rounded-xl p-2 text-slate-600 transition hover:bg-slate-100 dark:text-slate-400 dark:hover:bg-slate-800"
            ...
            {notifOpen ? (
              <div className="absolute right-0 mt-2 w-[min(100vw-2rem,380px)] origin-top-right overflow-hidden rounded-2xl border border-slate-200/90 bg-white shadow-2xl dark:border-slate-700 dark:bg-slate-900">
                <div className="flex items-center justify-between border-b border-slate-100 px-4 py-3 dark:border-slate-800">
                  ...
                  <div className="relative">
                    ...
                    {notifMenu ? (
                      <div className="absolute right-0 top-full z-10 mt-1 min-w-[180px] rounded-xl border border-slate-200 bg-white py-1 text-sm shadow-lg dark:border-slate-600 dark:bg-slate-800">
                ...
                <div className="flex gap-1 border-b border-slate-100 px-3 py-2 dark:border-slate-800">
                  <button
                    type="button"
                    className={`rounded-full px-4 py-1.5 text-xs font-bold ${notifTab === "all" ? "bg-indigo-600 text-white" : "text-slate-600 hover:bg-slate-100 dark:text-slate-400 dark:hover:bg-slate-800"}`}
                  ...
                  <button
                    type="button"
                    className={`rounded-full px-4 py-1.5 text-xs font-bold ${notifTab === "unread" ? "bg-indigo-600 text-white" : "text-slate-600 hover:bg-slate-100 dark:text-slate-400 dark:hover:bg-slate-800"}`}
                ...
                <ul className="max-h-[min(60vh,360px)] divide-y divide-slate-100 overflow-y-auto dark:divide-slate-800">
                  {filtered.length === 0 ? (
                    <li className="px-4 py-8 text-center text-sm text-slate-500 dark:text-slate-400">No notifications here.</li>
                  ) : (
                    filtered.map((n) => (
                      <li key={n.id}>
                        <button
          ...
          <Link
            href="/messages"
            className="relative hidden rounded-xl p-2 text-slate-600 transition hover:bg-slate-100 hover:text-indigo-600 dark:text-slate-400 dark:hover:bg-slate-800 dark:hover:text-indigo-400 sm:inline-flex"
            aria-label="Messages"
          >
            <svg className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden>
          ...
          <div className="relative" ref={menuRef}>
            ...
            {open ? (
              <div className="absolute right-0 mt-2 w-64 origin-top-right rounded-2xl border border-slate-200/90 bg-white py-2 shadow-lg dark:border-slate-700 dark:bg-slate-900">
                ...
                <Link
                  href="/settings"
                  className="flex items-center gap-2 px-4 py-2.5 text-sm font-medium text-slate-800 transition hover:bg-slate-50 dark:text-slate-100 dark:hover:bg-slate-800"
