      ...
      {open ? (
        <div className="fixed inset-0 z-[10000] flex items-center justify-center p-4" role="presentation">
          ...
          <div
            ...
            className="relative z-[1] w-full max-w-sm rounded-2xl border border-slate-200 bg-white p-6 shadow-2xl dark:border-slate-600 dark:bg-slate-900"
          >
            ...
            <button
              ...
              type="button"
              onClick={close}
              className="mt-6 w-full rounded-xl bg-indigo-600 py-2.5 text-sm font-semibold text-white transition hover:bg-indigo-500"
            >
              OK
            </button>
          </div>
